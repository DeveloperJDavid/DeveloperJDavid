...
<table border="0" width="100%">
  <tr>
    <td width="55%" align="center">
      <img src="https://github-readme-stats-three-virid-64.vercel.app/api?username=DeveloperJDavid&show_icons=true&theme=transparent&icon_color=FFFFFF&text_color=FFFFFF&title_color=FFFFFF&include_all_commits=true&count_private=true&locale=pt-br" alt="GitHub Stats" />
      <br/><br/>
...
* **Website institucional** – Desenvolvimento de site para Sorveteria (HTML, CSS, Node.js, React).
* **Projeto de soluções computacionais** – Aplicação de lógica de programação em projetos acadêmicos (JavaScript).
* **Estudos em Cibersegurança e IA** – Participação em cursos e práticas relacionadas a segurança da informação e inteligência artificial.

### Cursos Complementares
* **Lógica de Programação: mergulhe em programação com JavaScript** – Alura (2025)
* **HTML e CSS: ambientes de desenvolvimento, estrutura de arquivos e tags** – Alura (2025)
